...
var app = (function () {
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(style, file$b, 1, 4, 219);
    			...
    			add_location(path0, file$b, 5, 4, 316);
    			...
    			add_location(path1, file$b, 6, 4, 646);
    ...
    const file$a = "src/Confet.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$a, 324, 1, 9770);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$a(ctx) {
    	let if_block_anchor;
    	let current;
    	let if_block = /*isVisible*/ ctx[1] && /*isValid*/ ctx[2] && create_if_block$2(ctx);
    ...
    function instance$a($$self, $$props, $$invalidate) {
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty & /*particleCount*/ 64) {
    			// FOR FUN!!!
    			particleCount > 300 && console.log("[SVELTE-CONFETTI-EXPLOSION] That's a lot of confetti, you sure about that? A lesser number" + ' like 200 will still give off the party vibes while still not bricking the device 😉');
    		}
    ...
    const file$9 = "node_modules/svelte-materialify/dist/components/MaterialApp/MaterialApp.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$9, 12, 0, 203097);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$7, 441, 8, 11015);
    			...
    			add_location(div1, file$7, 413, 6, 10068);
    			...
    			add_location(div2, file$7, 407, 4, 9935);
    			...
    			add_location(div3, file$7, 398, 2, 9689);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$7, 432, 12, 10764);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-puby23");
    			add_location(h2, file$6, 11, 0, 131);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/ContentOutside.svelte generated by Svelte v3.46.4 */
    const file$5 = "src/ContentOutside.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button0.textContent = "Show a popup from an outside component!";
    			t2 = space();
    			br = element("br");
    			t3 = space();
    			button1 = element("button");
    			button1.textContent = "Show a popup from an outside component with custom props!";
    			t5 = space();
    			p = element("p");
    			p.textContent = "Just some text to overflow the body";
    			t7 = space();
    			button2 = element("button");
    			button2.textContent = "Show a popup from an outside component!";
    			attr_dev(hr, "class", "svelte-1d558q2");
    			add_location(hr, file$5, 24, 1, 445);
    			add_location(button0, file$5, 25, 1, 453);
    			add_location(br, file$5, 26, 1, 532);
    			add_location(button1, file$5, 27, 1, 540);
    			set_style(p, "padding", "500px 0");
    			add_location(p, file$5, 28, 1, 646);
    			add_location(button2, file$5, 31, 1, 721);
    			attr_dev(section, "class", "svelte-1d558q2");
    			add_location(section, file$5, 23, 0, 434);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(button0, "click", /*showPopup*/ ctx[0], false, false, false),
    					listen_dev(button1, "click", /*showPopupWithProps*/ ctx[1], false, false, false),
    					listen_dev(button2, "click", /*showPopup*/ ctx[0], false, false, false)
    				];
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots('ContentOutside', slots, []);
    	let opening = false;
    	let opened = false;
    	let closing = false;
    	let closed = false;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ContentOutside> was created with unknown prop '${key}'`);
    	});
    	...
    	return [showPopup, showPopupWithProps];
    }

    class ContentOutside extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    /* src/PopupLong.svelte generated by Svelte v3.46.4 */

    const file$4 = "src/PopupLong.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 15, 0, 145);
    			attr_dev(h20, "class", "svelte-1683fyu");
    			add_location(h20, file$4, 17, 0, 167);
    			add_location(p0, file$4, 18, 0, 197);
    			attr_dev(h21, "class", "svelte-1683fyu");
    			add_location(h21, file$4, 20, 0, 780);
    			add_location(p1, file$4, 21, 0, 807);
    			attr_dev(h22, "class", "svelte-1683fyu");
    			add_location(h22, file$4, 23, 0, 1429);
    			add_location(p2, file$4, 24, 0, 1463);
    			add_location(p3, file$4, 25, 0, 2234);
    			attr_dev(h23, "class", "svelte-1683fyu");
    			add_location(h23, file$4, 27, 0, 2538);
    			add_location(p4, file$4, 28, 0, 2569);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class PopupLong extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*message*/ ctx[0] === undefined && !('message' in props)) {
    			console.warn("<PopupLong> was created without expected prop 'message'");
    		}
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = text("How many adults?:\n    ");
    			input2 = element("input");
    			t6 = space();
    			label3 = element("label");
    			t7 = text("How many children?:\n    ");
    			input3 = element("input");
    			t8 = space();
    			button = element("button");
    			button.textContent = "Send";
    			set_style(input0, "border-radius", "25px");
    			set_style(input0, "border", "1px solid black");
    			attr_dev(input0, "type", "email");
    			attr_dev(input0, "name", "email");
    			attr_dev(input0, "class", "svelte-uqjv6u");
    			add_location(input0, file$3, 57, 4, 1095);
    			attr_dev(label0, "class", "svelte-uqjv6u");
    			add_location(label0, file$3, 55, 2, 1067);
    			set_style(input1, "border", "1px solid black");
    			set_style(input1, "border-radius", "25px");
    			attr_dev(input1, "type", "name");
    			attr_dev(input1, "name", "name");
    			attr_dev(input1, "class", "svelte-uqjv6u");
    			add_location(input1, file$3, 61, 4, 1220);
    			attr_dev(label1, "class", "svelte-uqjv6u");
    			add_location(label1, file$3, 59, 2, 1193);
    			attr_dev(input2, "type", "number");
    			set_style(input2, "border-radius", "25px");
    			set_style(input2, "border", "1px solid black");
    			set_style(input2, "width", "25%");
    			attr_dev(input2, "name", "adults");
    			input2.value = "1";
    			attr_dev(input2, "class", "svelte-uqjv6u");
    			add_location(input2, file$3, 66, 4, 1393);
    			attr_dev(label2, "class", "svelte-uqjv6u");
    			add_location(label2, file$3, 64, 2, 1359);
    			attr_dev(input3, "type", "number");
    			set_style(input3, "border-radius", "25px");
    			set_style(input3, "border", "1px solid black");
    			set_style(input3, "width", "25%");
    			attr_dev(input3, "name", "children");
    			input3.value = "0";
    			attr_dev(input3, "class", "svelte-uqjv6u");
    			add_location(input3, file$3, 70, 4, 1549);
    			attr_dev(label3, "class", "svelte-uqjv6u");
    			add_location(label3, file$3, 68, 2, 1513);
    			set_style(button, "font-family", "'open sans',arial,sans-serif");
    			set_style(button, "font-size", "1em");
    			attr_dev(button, "type", "submit");
    			add_location(button, file$3, 72, 2, 1671);
    			attr_dev(form, "action", "https://formspree.io/f/mnqwgjpl");
    			attr_dev(form, "method", "POST");
    			add_location(form, file$3, 51, 0, 998);
    			attr_dev(h2, "class", "svelte-uqjv6u");
    			add_location(h2, file$3, 49, 1, 922);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('onOkay' in $$props) $$invalidate(3, onOkay = $$props.onOkay);
    	};
    	...
    	onChange(value);
    	return [message, hasForm, onCancel, onOkay];
    }
    ...
    /* src/CloseButton.svelte generated by Svelte v3.46.4 */

    const file$2 = "src/CloseButton.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 16, 0, 259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class CloseButton extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$2, create_fragment$2, safe_not_equal, { onClose: 0 });
    ...
    // (114:27) <Button on:click={showDialog} fab size="large" class="red white-text rounded">
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(114:27) <Button on:click={showDialog} fab size=\\\"large\\\" class=\\\"red white-text rounded\\\">",
    		ctx
    	});
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			p = element("p");
    			em = element("em");
    			em.textContent = "RSVP was canceled";
    			add_location(em, file$1, 117, 5, 2351);
    			add_location(p, file$1, 117, 2, 2348);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t1 = text(/*name*/ ctx[4]);
    			t2 = text("!");
    			add_location(p, file$1, 115, 2, 2295);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    			append_dev(p, t0);
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*name*/ 16) set_data_dev(t1, /*name*/ ctx[4]);
    		},
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(p);
    		}
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 128, 3, 2566);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 126, 3, 2519);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 124, 3, 2474);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 122, 3, 2427);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	button.$on("click", /*showDialog*/ ctx[6]);

    	function select_block_type(ctx, dirty) {
    		if (/*status*/ ctx[5] === 1) return create_if_block_4;
    		if (/*status*/ ctx[5] === -1) return create_if_block_5;
    	}
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*opening*/ ctx[0]) return create_if_block;
    		if (/*opened*/ ctx[1]) return create_if_block_1;
    		if (/*closing*/ ctx[2]) return create_if_block_2;
    	...
    	const block = {
    		c: function create() {
    			...
    			set_style(p, "font-size", "40px");
    			add_location(p, file$1, 113, 1, 2143);
    			attr_dev(div, "id", "state");
    			attr_dev(div, "class", "svelte-kixxzo");
    			add_location(div, file$1, 120, 1, 2391);
    			attr_dev(section, "class", "svelte-kixxzo");
    			add_location(section, file$1, 111, 0, 2130);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const showPopupCustom = () => {
    		open(
    			...
    			{ message: "It's a customized popup!" },
    			{
    				...
    				styleBg: { background: 'rgba(200, 255, 0, 0.66)' },
    				styleWindowWrap: { margin: '4rem' },
    				styleWindow: {
    				...
    				transitionWindowProps: { y: 100, duration: 1000 }
    			},
    			{
    				onOpen: () => {
    					$$invalidate(0, opening = true);
    				},
    				onOpened: () => {
    					$$invalidate(0, opening = false);
    	...
    	return [opening, opened, closing, closed, name, status, showDialog];
    }
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(title, file, 13, 0, 360);
    			attr_dev(span0, "class", "svelte-x82p7h");
    			add_location(span0, file, 15, 4, 412);
    			add_location(p0, file, 15, 1, 409);
    			attr_dev(span1, "class", "svelte-x82p7h");
    			add_location(span1, file, 16, 4, 438);
    			add_location(p1, file, 16, 1, 435);
    			attr_dev(span2, "class", "svelte-x82p7h");
    			add_location(span2, file, 17, 4, 463);
    			attr_dev(span3, "class", "svelte-x82p7h");
    			add_location(span3, file, 18, 1, 482);
    			add_location(p2, file, 17, 1, 460);
    			attr_dev(span10, "class", "svelte-x82p7h");
    			add_location(span10, file, 19, 4, 505);
    			attr_dev(span11, "class", "svelte-x82p7h");
    			add_location(span11, file, 19, 24, 525);
    			set_style(span3_1, "position", "relative");
    			set_style(span3_1, "top", "-1em");
    			set_style(span3_1, "opacity", "1");
    			attr_dev(span3_1, "class", "svelte-x82p7h");
    			add_location(span3_1, file, 19, 40, 541);
    			attr_dev(span12, "class", "svelte-x82p7h");
    			add_location(span12, file, 19, 103, 604);
    			add_location(p3, file, 19, 1, 502);
    			attr_dev(main, "class", "svelte-x82p7h");
    			add_location(main, file, 14, 0, 401);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
